<?php 
//Template Name: Portfolio-4-column-v2
get_header();
	...
	{ 	 
		...
		$args = array (
			...
			<?php	while ( $portfolio_query->have_posts() ) : 
				...
				?>
		   <div class="col-xs-12 col-sm-6 col-md-3 portfolio-item-wrapper gallery-col <?php foreach ($tax_terms as $term) {   $tax_term = str_replace(' ', '_', $term);  echo preg_replace('~[^A-Za-z\d\s-]+~u', 'wl', $tax_term). " "; } ?>">
