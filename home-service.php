...
<div class="home_services_section">
  ...
  <div class="main-title">
	 <h2 class="wow fadeInLeft animated animated" data-wow-duration="4s"><?php echo $service_setting['service_title_one']; ?><span><?php echo $service_setting['service_title_two']; ?></span> </h2> 
	</div>
